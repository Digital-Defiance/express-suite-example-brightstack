...
export const ComponentId = 'DigitaldefianceExpressSuiteExampleBrightchain';

const setup = createI18nSetup({
  componentId: ComponentId,
  stringKeyEnum: DigitaldefianceExpressSuiteExampleBrightchainStringKey,
  strings: {
  ...
  aliases: ['DigitaldefianceExpressSuiteExampleBrightchainStringKey'],
