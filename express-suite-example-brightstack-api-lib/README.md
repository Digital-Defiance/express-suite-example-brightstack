# express-suite-example-brightstack-api-lib

API business logic library for digitaldefiance-express-suite-example-brightstack.
...
```typescript
import { App, Environment, Constants } from '@express-suite-example-brightstack/api-lib';
```
