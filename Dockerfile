...
# Run: yarn build && docker build -t express-suite-example-brightchain .
...
COPY dist/express-suite-example-brightchain-api ./
COPY dist/express-suite-example-brightchain-react ./dist/express-suite-example-brightchain-react
