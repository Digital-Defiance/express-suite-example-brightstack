...
# Run: yarn build && docker build -t express-suite-example-brightstack .
...
COPY dist/express-suite-example-brightstack-api ./
COPY dist/express-suite-example-brightstack-react ./dist/express-suite-example-brightstack-react
